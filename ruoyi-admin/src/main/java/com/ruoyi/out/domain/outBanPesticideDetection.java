...
/**
 * 蔬菜水果禁用农药检出样品明细对象 out_ban_pesticide_detection
 * 
 * @author chenjie
 * @date 2024-01-27
 */
public class outBanPesticideDetection extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("banPesticideDetectionId", getBanPesticideDetectionId())
