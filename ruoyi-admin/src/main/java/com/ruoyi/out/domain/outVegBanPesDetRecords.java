...
/**
 * 蔬菜禁用农药检出及超标情况对象 out_veg_ban_pes_det_records
 * 
 * @author chenjie
 * @date 2024-01-27
 */
public class outVegBanPesDetRecords extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 唯一标识每条检测记录 */
    private Long vegBanPesDetRecordsId;
    ...
    public void setVegBanPesDetRecordsId(Long vegBanPesDetRecordsId) 
    {
        this.vegBanPesDetRecordsId = vegBanPesDetRecordsId;
    }

    public Long getVegBanPesDetRecordsId() 
    {
        return vegBanPesDetRecordsId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("vegBanPesDetRecordsId", getVegBanPesDetRecordsId())
