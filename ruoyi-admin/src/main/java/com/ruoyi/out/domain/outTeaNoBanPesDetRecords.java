...
/**
 * 茶叶上非禁止使用农药检出及超标情况对象 out_tea_no_ban_pes_det_records
 * 
 * @author chenjie
 * @date 2024-04-08
 */
public class outTeaNoBanPesDetRecords extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 唯一标识每条检测记录 */
    private Long teaNoBanPesDetRecordsId;
    ...
    public void setTeaNoBanPesDetRecordsId(Long teaNoBanPesDetRecordsId) 
    {
        this.teaNoBanPesDetRecordsId = teaNoBanPesDetRecordsId;
    }

    public Long getTeaNoBanPesDetRecordsId() 
    {
        return teaNoBanPesDetRecordsId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("teaNoBanPesDetRecordsId", getTeaNoBanPesDetRecordsId())
