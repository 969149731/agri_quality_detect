...
/**
 * 茶叶种类及数量对象 out_tea_qualification
 * 
 * @author chenjie
 * @date 2024-04-08
 */
public class outTeaInventory extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 唯一标识符 */
    private Long teaInventoryId;
    ...
    public void setTeaInventoryId(Long teaInventoryId) 
    {
        this.teaInventoryId = teaInventoryId;
    }

    public Long getTeaInventoryId() 
    {
        return teaInventoryId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("teaInventoryId", getTeaInventoryId())
