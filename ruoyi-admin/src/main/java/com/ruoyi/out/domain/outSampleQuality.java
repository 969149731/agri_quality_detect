...
抽样环节 */
    ...
    public void addToSelfTotal(){
        this.totalSamplingCount=this.fruSamplingCount+this.vegSamplingCount+this.teaSamplingCount;
        this.totalQualifiedCount=this.fruQualifiedCount+this.vegQualifiedCount+this.teaQualifiedCount;
    }
