 ...
 */
@RestController
@RequestMapping("/detection/DetectionDetailsZXJC")
public class agriCitySampleTestDetailsZXJCController extends BaseController
{
     ...
     * 查询专项检测详细列表
     */
    @PreAuthorize("@ss.hasPermi('detection:DetectionDetailsZXJC:list')")
    @GetMapping("/list")
    public TableDataInfo list(agriCitySampleTestDetails agriCitySampleTestDetails)
    {
        startPage();
        String samplingType="专项检测";
     ...
     * 导出专项检测详细列表
     */
    @PreAuthorize("@ss.hasPermi('detection:DetectionDetailsZXJC:export')")
    @Log(title = "专项检测详细", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, agriCitySampleTestDetails agriCitySampleTestDetails)
    {
        ...
        util.exportExcel(response, list, "专项检测详细数据");
    }

    /**
     * 获取专项检测详细详细信息
     */
    @PreAuthorize("@ss.hasPermi('detection:DetectionDetailsZXJC:query')")
     ...
     * 新增专项检测详细
     */
    @PreAuthorize("@ss.hasPermi('detection:DetectionDetailsZXJC:add')")
    @Log(title = "专项检测详细", businessType = BusinessType.INSERT)
    @PostMapping
     ...
     * 修改专项检测详细
     */
    @PreAuthorize("@ss.hasPermi('detection:DetectionDetailsZXJC:edit')")
    @Log(title = "专项检测详细", businessType = BusinessType.UPDATE)
    @PutMapping
     ...
     * 删除专项检测详细
     */
    @PreAuthorize("@ss.hasPermi('detection:DetectionDetailsZXJC:remove')")
    @Log(title = "专项检测详细", businessType = BusinessType.DELETE)
