...
<script>
import { listOutFruBanPesDetRecords,
  samplingAddressProvince,findBySamplingProvinceCode,findBySamplingCityCode} from "@/api/out/outFruBanPesDetRecords";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listOutFruBanPesDetRecords(this.addDateRange(this.queryParams, this.dateRange)).then(response => {//二维表使用的列表获取
