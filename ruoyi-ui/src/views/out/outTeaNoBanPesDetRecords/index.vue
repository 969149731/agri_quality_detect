...
<script>
import { listOutTeaNoBanPesDetRecords
  ,samplingAddressProvince,findBySamplingProvinceCode,findBySamplingCityCode} from "@/api/out/outTeaNoBanPesDetRecords";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listOutTeaNoBanPesDetRecords(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
