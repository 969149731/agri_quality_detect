<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="outDlDetectRecordsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="蔬菜抽样数" align="center" prop="vegSamplingCount" />
      <el-table-column label="蔬菜合格数" align="center" prop="vegQualifiedCount" />
      <el-table-column label="蔬菜合格率" align="center" prop="vegPassRate" />
      <el-table-column label="水果抽样数" align="center" prop="fruSamplingCount" />
      <el-table-column label="水果合格数" align="center" prop="fruQualifiedCount" />
      ...
      <el-table-column label="总合格率，百分比" align="center" prop="allPassRate" />
