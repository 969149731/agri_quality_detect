<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="所属省份编码" prop="provinceCode">
        <el-input
          v-model="queryParams.provinceCode"
          placeholder="请输入所属省份编码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['address:city:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['address:city:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="cityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="城市编码" align="center" prop="code" />
      <el-table-column label="城市名称" align="center" prop="name" />
      <el-table-column label="所属省份编码" align="center" prop="provinceCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属省份编码" prop="provinceCode">
          <el-input v-model="form.provinceCode" placeholder="请输入所属省份编码" />
        </el-form-item>
      </el-form>
...
<script>
import { listCity, getCity, delCity, addCity, updateCity } from "@/api/address/city";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        provinceCode: [
          { required: true, message: "所属省份编码不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除城市信息编号为"' + ids + '"的数据项？').then(function() {
        return delCity(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('address/city/export', {
        ...this.queryParams
