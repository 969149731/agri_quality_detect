<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['address:province:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['address:province:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['address:province:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['address:province:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="provinceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="省份编码" align="center" prop="code" />
      <el-table-column label="省份名称" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="省份编码" prop="code">
          <el-input v-model="form.code" placeholder="请输入省份编码" />
        </el-form-item>
        <el-form-item label="省份名称" prop="name">
...
<script>
import { listProvince, getProvince, delProvince, addProvince, updateProvince } from "@/api/address/province";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('address/province/export', {
        ...this.queryParams
