...
<!--      </el-form-item>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="检测类型" prop="samplingType">
          <el-input v-model="form.samplingType" placeholder="监督抽查" disabled />
        </el-form-item>
...
} from "@/api/detection/DetectionDetailsJDCC";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/detection/DetectionDetailsJDCC/importData"
      },
      // 表单参数
      form: {
        samplingType: '监督抽查'  // 设置默认值为"监督抽查"
      },
      // 表单校验
      rules: {
      }
  ...
  methods: {
    ...
    getList() {
      ...
      listDetectionDetailsJDCC(this.addDateRange(this.queryParams, this.dateRange))
        .then(response => {
